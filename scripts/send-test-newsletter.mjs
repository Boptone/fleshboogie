...
async function sendTestNewsletter() {
  try {
    console.log('📧 Sending test newsletter to hello@fleshboogie.com...\n');
    
    const { data, error } = await resend.emails.send({
      from: 'FLESHBOOGIE <hello@fleshboogie.com>',
      to: ['hello@fleshboogie.com'],
    ...
    console.log('📧 Sent to: hello@fleshboogie.com');
    console.log(`📅 Date: ${dateStr}`);
    console.log(`📰 Stories included: ${content.mainColumn.length + 10} total`);
    console.log('\nCheck your inbox at hello@fleshboogie.com!');
